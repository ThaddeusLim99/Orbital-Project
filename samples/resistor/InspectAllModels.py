...
#LOAD MODEL
#TODO - update path
weights_path_main = os.path.join(MODEL_DIR, "resistor20210519T1931") #Choose which model to load

#Loops through every weight
for weights in os.listdir(weights_path_main):
    if weights.endswith(".h5"):

        weights_path = os.path.join(weights_path_main, weights)
        ...
        '''
        #Detecting image not from dataset
        ...
        plt.savefig(f'{weights}img.jpg',bbox_inches='tight', pad_inches=-0.5,orientation= 'landscape') #TODO: Change file name
        ...
        #Extract the masks and save them
        '''
